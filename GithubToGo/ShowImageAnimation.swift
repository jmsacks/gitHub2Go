...
class ShowImageAnimator: NSObject, UIViewControllerAnimatedTransitioning {
    ...
    func animateTransition(transitionContext: UIViewControllerContextTransitioning) {
        ...
        let fromViewController = transitionContext.viewControllerForKey(UITransitionContextFromViewControllerKey) as UserCollectionViewViewController
        ...
        toViewController.profileImage.frame = toViewController.view.bounds
        ...
        UIView.animateWithDuration(1.0, delay: 0.0, options: UIViewAnimationOptions.CurveEaseInOut, animations: { () -> Void in
           ...
           // toViewController.profileImage.frame = fromViewController.view.bounds
            }) { (finished) -> Void in
